...
class SubscriptionFileGeneric implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'shipment_reference_number' => OneOfSubscriptionFileGenericShipmentReferenceNumber::class,
        'package_reference_number' => OneOfSubscriptionFileGenericPackageReferenceNumber::class,
