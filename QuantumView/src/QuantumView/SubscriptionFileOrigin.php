...
class SubscriptionFileOrigin implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'package_reference_number' => OneOfSubscriptionFileOriginPackageReferenceNumber::class,
        'shipment_reference_number' => OneOfSubscriptionFileOriginShipmentReferenceNumber::class,
